...
def hangman():
    ...
    word = random.choice(["ironman" ,"quicksilver","blackpanther", "hawkeye" , "mandarin" , "thor" ,"ghostrider","loki","spiderman","hulk","vision","wolverine","deadpool","iceman","groot" , "thanos"  ])
